...
export const mockAthletes: Athlete[] = [
  ...
  },
  {
    ...
    twitterLink: "https://x.com/RodneyColton24",
    tier: "pro",
    proAnalysis: {
      rating: 89,
  ...
  {
    id: "21",
    name: "Kendrick 'KJ' Howard",
    sport: "Football",
    position: "Linebacker",
    location: "Douglasville, Georgia",
    avatar: "/images/athletes/kj-howard.jpeg",
    achievements: ["Top LB Prospect 2028", "1 Division 1 College Offer"],
    supportNeeded: ["Career", "Education"],
    yearsActive: "2024-2028",
    status: "active",
    classYear: "2028",
    ...
    height: "6'0\"",
    weight: "195 lbs",
    hudlLink: "http://www.hudl.com/v/2Sts9r",
    instagramLink: "https://www.instagram.com/kjx_howard",
    twitterLink: "https://x.com/kjhoward_37",
    tier: "pro",
    proAnalysis: {
      rating: 82,
      analysis: "Kendrick 'KJ' Howard is a dynamic linebacker who plays with rare intensity and versatility. At 6'0\" and 195 lbs, he combines the speed of a defensive back with the violence of the meanest defensive lineman—a terrifying combination for opposing offenses. As he prepares for his first full year as a starter, KJ is poised to take the state of Georgia by storm. His explosive closing speed and aggressive tackling style make him a disruptive force at the second level. With continued development in coverage skills and pass-rush technique, KJ has the tools to become one of the top linebacker prospects in the 2028 class.",
      assessor: durrellSteen,
    },
  },
  {
    ...
    height: "6'4\"",
    weight: "220 lbs",
    hudlLink: "http://www.hudl.com/v/2THNhh",
    tier: "pro",
    proAnalysis: {
      rating: 78,
      analysis: "Steven McClendon is a young defensive lineman with great size and an incredibly high motor. At 6'4\" and 220 lbs as a sophomore, he has the frame to add significant weight while maintaining his athleticism. What stands out most about Steven is his relentless effort—he never quits on a play and brings energy on every snap. His Second Team All-Region selection validates his impact at the high school level. While he currently lacks refined pass rush techniques, his ceiling is extremely high given his physical tools and work ethic. With proper technique coaching, Steven has the potential to become a dominant defensive end at the collegiate level.",
      assessor: durrellSteen,
    },
  },
  {
